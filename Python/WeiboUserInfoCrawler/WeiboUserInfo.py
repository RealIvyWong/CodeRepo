    ...
    for i in range(len(uid)):
        ...
        while True:
            ...
            try:
                ...
                if en==10:
                    print('需要更换cookies了')
                    yag.send(to = ['924154233@qq.com'], subject = 'userinfo代码要换cookie了！！', contents = ['Check it!休息20分钟先'])
                    time.sleep(1200)
                    print('更换完毕，继续')
                    cookies=getcookies()
                    en=0
            ...
            if flag == True:
                ...
                if en==10:
                    print('需要更换cookies了')
                    yag.send(to = ['924154233@qq.com'], subject = 'userinfo代码要换cookie了！！', contents = ['Check it!'])
                    t=input('更换完毕，则按回车继续：')
                    cookies=getcookies()
                    en=0
...
if __name__ == '__main__':
    while True:
        ...
        print('这段时间的用户信息爬取完毕')
        yag.send(to = ['924154233@qq.com'], subject = '这段时间的用户信息爬取完毕', contents = ['三小时后再继续'])
        time.sleep(10800)
